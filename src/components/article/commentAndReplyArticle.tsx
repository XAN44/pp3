...
import { DELETE, DELETEReply, replyComments, replyCommentsBlog } from '@/lib/actions/user.comment'
...
const CommentAndReplyArticle = ({
    ...
    const handleDeleteReply = async (replyId: string) => {
        try {
            await DELETEReply(replyId, path);
    ...
    const onSubmitReply = async (values: z.infer<typeof replyComment>) => {
        await replyCommentsBlog(id || '', values.reply, current.id || '', path)
        replyForm.reset()
    }
...
export default CommentAndReplyArticle
